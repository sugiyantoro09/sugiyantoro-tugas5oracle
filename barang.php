            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <a class='btn btn-primary' href='add_mobil.php' ><i class='fa fa-plus'></i> Tambah Data Barang</a>
                </div>
            ...
            <?php echo $d['HARGA_BARANG']; ?>
                        ...
                        <td class="td-actions">
						 <a class='btn btn-success' href="update_barang.php?KODE_BARANG=<?php echo $d["KODE_BARANG"];?>" 
							...
							href="aksi_mobil.php?act=delete&KODE_BARANG=<?php echo $d["KODE_BARANG"];?>" 
