                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="KODE_BARANG" placeholder="masukkan kode">
                      </div>
                    <div class="form-group">
                      <label for="TANGGAL_TRANSAKSI">Tanggal</label>
                      <input type="text" class="form-control" name="TANGGAL_TRANSAKSI" placeholder="TANGGAL_TRANSAKSI">
                    </div>
                    <div class="form-group">
                      <label for="NAMA_PEMBELI">Pembeli</label>
                      <input type="number" class="form-control" name="NAMA_PEMBELI" placeholder="Nama pembeli">
