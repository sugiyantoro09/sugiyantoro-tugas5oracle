      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
		  ...
		  <div class="row">
			...
			$stid = oci_parse($koneksi, "SELECT * FROM BARANG WHERE KODE_BARANG='$kode_barang'");
			oci_execute($stid);
                ...
                <div class="card-body">
                  <form method='post' action='aksi_barang.php?act=update'>
					...
					<input type="hidden" name="kode_barang" value="<?php echo $d["KODE_BARANG"]; ?>">
                      ...
                      <input type="text" class="form-control" name="KODE_KARYAWAN" value="<?php echo $d["KODE_KARYAWAN"]; ?>">
                      </div>
                      <div class="form-group">
